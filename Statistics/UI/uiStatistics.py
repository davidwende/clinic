...
from PySide6.QtWidgets import (QApplication, QButtonGroup, QCheckBox, QComboBox,
    QGridLayout, QGroupBox, QHBoxLayout, QLabel, QListView, QDateEdit, QCalendarWidget,
...
class uiStatistics(QMainWindow):
    def __init__(self):
        super().__init__()

        layVerticalTop       = QVBoxLayout()
        layChooseDates = QHBoxLayout()
        # layData = QGridLayout()
        layHorizontalButtons = QHBoxLayout()

        # layHorizontalPatient
        self.lb_StartDate = QDateEdit(calendarPopup = True)
